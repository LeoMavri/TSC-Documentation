...
**// mavri: the gap between 2 and its subpoints are killing me**

1. Read the [terminology](/terminology)
1. A **Limited Access** Torn API key
...
1. A Discord account verified with Torn
...
TLDR:
* move to [Zen Browser](https://zen-browser.app/) if you're on Google Chrome
* Use Tampermonkey
